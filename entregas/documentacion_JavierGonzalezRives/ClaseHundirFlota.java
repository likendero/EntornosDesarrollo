package documentacionTra;
import java.io.BufferedReader;
import java.io.IOException;
import java.io.InputStreamReader;

/**
 * Creacion del juego undir la flota en modo texto
 * @author Luisa
 *
 */
public class ClaseHundirFlota {
	 ...
	 * @param args cadena entrada salida
	 *******************************************************************************************************/
	 ...
	 */
	/**
	 * metodo que dibuja los paneles del usuario
	 * @param matrizUsuario
	 * @param barcosUsuario
	 * @param matrizMaquina
	 * @param barcosMaquina
	 ...
	 */
	/**
	 * metodo que sirve para actualizar el estado de la matriz
	 * @param matriz matriz almacen
	 * @param barcos numero de barco
	 * @param tiro numro de tiro
	 */
	 ...
	 */
	/**
	 * Metodo que se usa al iniciar el juego para colocar los barcos
	 * @param matrizUsuario
	 * @param matrizMaquina
	 * @param barcos
	 */
	 ...
	 */
	/**
	 * funcion que se encarga de colocar los barcos la maguina
	 * @param matrizMaquina matriz de los barcos de la maquina
	 * @param barcos identificador de los barcos
	 */
	 ...
	 */
	/**
	 * metodo para el guiado del usuario y la colocacion de sus barcos
	 * @param matrizUsuario matriz donde se almacena barcos usuario
	 * @param barcos numero de barco
	 */
	 ...
	 */
	/**
	 * metodo usado en la colocacion de los barcos para preguntarle al usuario sus decisiones
	 * @param tamanhoBarco
	 * @return barco devuelve el numero de posiciones y las posiciones del barco
	 */
	 ...
	 */
	/**
	 * metodo que se utiliza para la peticion de posiciones y casillas por teclado
	 * @param cadenaMensaje
	 * @return pregunta al usuario que casilla desea
	 */
	 ...
	 */
	/**
	 * metodo que se encarga de acutalizar la matriz una vez que el tiro es valido
	 * @param matriz
	 * @param fila
	 * @param columna
	 * @param posicion
	 ...
	 */
	/**
	 * funcion que comprueba si hemos terminado el juego
	 * @param barcos
	 * @return true si lo hemos terminado flase si no
	 */
	 ...
	 */
	/**
	 * metodo que se encarga de comprobar si la casilla indicada esta dentro del tablero
	 * @param fila
	 * @param columna
	 * @return devuelve true o false segun la casilla es valida o no
	 */
	 ...
	 */
	/**
	 * comprobacion si la colocacion del barco del usuario es correcta
	 * <em> la correccion hace referencia a si se encuentra en los limites aceptados</em>
	 * @param fila
	 * @param columna
	 * @param posicion
	 * @param tamanho
	 * @param matriz
	 * @return comprueba el estado del barco
	 */
	 ...
	 */
	/**
	 * funcion que comprueba que el tiro del jugador actual no ha sido realizado antes y no esta 
	 * fuera de los limites
	 * @param valores
	 * @param matriz
	 * @return comprueba el resultado del disparo
	 */
	 ...
	 */
	/**
	 * creacion del panel de los disparos realizados,
	 * <p>creacion de la matriz con todo en principio = agua</p>
	 * @return la matriz de disparos
	 */
	 ...
	 */
	/**
	 * creacion de la tabla donse se situan los barcos
	 * @return crea los barcos
	 */
	 ...
	 */
	/**
	 * creacion de un array segun numero de caracteres
	 * 
	 * @param numCaracteres que contiene
	 * @return caracteres
	 * 
	 */
